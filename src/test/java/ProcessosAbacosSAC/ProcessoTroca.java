...
public class ProcessoTroca {
    ...
    public void DevolucaoComReembolso() throws InterruptedException {
        ...
        //Selecionando a opção Troca
        Thread.sleep(1500);
        driver.findElement(By.xpath(".//*[@id='ctl00_MainContainer_PageTrocaDevolucao_pnlItensPedido_rptItensPedido_ctl00_cmbObjetivo_DDD_L_LBI1T0']")).click();
        ...
        // Apresentar a lista de produtos substitutos
        driver.findElement(By.xpath("//td[@id='ctl00_MainContainer_PageTrocaDevolucao_pnlItensPedido_rptItensPedido_ctl00_pnlItensPedidoProdutosSubstitutos_cmbItensPedidosProdutosSubstitutos_B-1']")).click();
        // Selecionar o produto substituto
        driver.findElement(By.xpath("//td[@id='ctl00_MainContainer_PageTrocaDevolucao_pnlItensPedido_rptItensPedido_ctl00_pnlItensPedidoProdutosSubstitutos_cmbItensPedidosProdutosSubstitutos_DDD_L_LBI1T1']")).click();
        Screenshot.tirar(driver, "C:\\Users\\lucas.menezes\\Documents\\EvidenciasAut\\" + Generator.dataHoraParaArquivo() + "Produto Substituto.png");

        //Adicionar Frete em caso de 2º troca
        //driver.findElement(By.xpath("//input[@id='ctl00_MainContainer_PageTrocaDevolucao_pnlDadosEntrega_txtValorFrete_I']")).sendKeys(Keys.HOME + "12");
        //Screenshot.tirar(driver, "C:\\Users\\lucas.menezes\\Documents\\EvidenciasAut\\" + Generator.dataHoraParaArquivo() + "Adição do Frete.png");
        ...
        Screenshot.tirar(driver, "C:\\Users\\lucas.menezes\\Documents\\EvidenciasAut\\" + Generator.dataHoraParaArquivo() + "Confirmação da Troca.png");
